...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <table align="center" class="auto-style9" border="0" 
              ...
              <uc1:top ID="top1" runat="server" />
                    <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_ItemCommand">
                            <ItemTemplate>
                                    ...
                                    <tr>
                                    <td colspan="5" rowspan="1" style="";width: 794px; height: 1px; text-align: center"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <td style="width: 374px; height: 23px; text-align:left; ">
